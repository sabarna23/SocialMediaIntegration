...
public class GmailUser extends AppCompatActivity implements GmailUser2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(GmailUser.this);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(GmailUser.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if(status.isSuccess()){
                                            ...
                                            Toast.makeText(GmailUser.this, "Gmail Logged out successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(GmailUser.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }else{
                                            Toast.makeText(GmailUser.this, "Gmail Log out failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
